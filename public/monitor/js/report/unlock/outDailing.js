function initTable($table) {
	...
	$table.bootstrapTable({
		//url:'../../data/unlock/outDailing.json',//请求后台的URL
		url:'/POCReportAdmin/dailServlet',
		method: 'get',//请求方式
...
//		clickToSelect: true,//是否启用点击选中行
		...
		columns: [
			...
			{field:"resultCode",title:"外拨应答状态",align:"center",valign:"middle",sortable:"true"},
			{field:"Callstarttime",title:"呼叫开始时间",align:"center",valign:"middle",sortable:"true"},
			{field:"CallConnTime",title:"呼叫连接时间",align:"center",valign:"middle",sortable:"true"},
			{field:"Callendtime",title:"呼叫完成时间",align:"center",valign:"middle",sortable:"true"}
		],
