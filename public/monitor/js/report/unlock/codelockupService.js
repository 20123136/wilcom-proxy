function initTable($table) {
	...
	$table.bootstrapTable({
		//url:'../../data/unlock/codelockupService.json',//请求后台的URL
		url:'/POCReportAdmin/codelockupServiceServlet',
		method: 'get',//请求方式
...
//		clickToSelect: true,//是否启用点击选中行
		...
		columns: [
			...
			{field:"tradeTime",title:"交易时间",align:"center",valign:"middle",sortable:"true"},
			{field:"tradeMoney",title:"交易金额",align:"center",valign:"middle",sortable:"true"},
			{field:"currency",title:"币种",align:"center",valign:"middle",sortable:"true"},
			{field:"isDial",title:"是否触发外拨",align:"center",valign:"middle",sortable:"true"},
			{field:"dailAbandonReason",title:"放弃外拨原因",align:"center",valign:"middle",sortable:"true"},
			{field:"Callstarttime",title:"触发外拨时间",align:"center",valign:"middle",sortable:"true"}
		],
...
$(function(){
	var $table = $('#codelockupServiceTable');
	initTable($table);
	var search = $('#search');
