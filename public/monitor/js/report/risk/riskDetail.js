function initTable($table) {
	...
	$table.bootstrapTable({
		//url:'../../data/bill/riskDetail.json',//请求后台的URL
		url:'/POCReportAdmin/riskDetailServlet',
		method: 'get',//请求方式
...
//		clickToSelect: true,//是否启用点击选中行
		...
		columns: [
			...
			{field:"idCardNo",title:"身份证号码",align:"center",valign:"middle",sortable:"true"},
			...
			{field:"callResult",title:"外拨结果",align:"center",valign:"middle",sortable:"true"}
		],
