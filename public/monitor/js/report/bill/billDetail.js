function initTable($table) {
	...
	$table.bootstrapTable({
		//url:'../../data/bill/billDetail.json',//请求后台的URL
		url:'/POCReportAdmin/billDetailServlet',
		method: 'get',//请求方式
...
//		searchOnEnterKey:true,//是否触发按回车搜索
//		stricSearch : true,//是否全匹配搜索
...
//		clickToSelect: true,//是否启用点击选中行
		...
		columns: [
			...
			{field:"phoneNo",title:"手机号",align:"center",valign:"middle",sortable:"true"},
			{field:"gender",title:"性别",align:"center",valign:"middle",sortable:"true"},
			//,sorter:"timeSorter"
			{field:"callTime",title:"外拨时间",align:"center",valign:"middle",sortable:"true"},
			{field:"callNum",title:"拨打次数",align:"center",valign:"middle",sortable:"true"},
			{field:"callResult",title:"拨打结果",align:"center",valign:"middle",sortable:"true"}
		],
        ...
        onLoadError: function(data){  //加载失败时执行  
          ...
          console.info("加载失败");
          console.info('billDetail.Error'+data);
        },  
